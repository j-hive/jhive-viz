...
export function make_selector_options_from_metadata(metadataJSON, defaultValue, addNone = false) {
...
export function add_data_options_to_axis_selectors(metadataJSON, x_default = "ra", y_default = "dec") {
